...
srand(time(NULL)); //inicializa la semilla aleatoria en funcion del tiempo
  ...
  for (int i = 0; (strlen(cohete) <= pos_final || strlen(cohete2) <= pos_final || strlen(cohete3) <= pos_final || strlen(cohete4) <= pos_final || strlen(cohete5) <= pos_final || strlen(cohete6) <= pos_final || strlen(cohete7) <= pos_final || strlen(cohete8) <= pos_final || strlen(cohete9) <= pos_final || strlen(cohete10) <= pos_final) ; i++) {
