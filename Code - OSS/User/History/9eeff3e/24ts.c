...
srand(time(NULL)); //inicializa la semilla aleatoria en funcion del tiempo
  ...
  char cohete[N] = "", cohete2[N] = "", cohete3[N] = "", cohete4[N] = "", cohete5[N] = "", cohete6[N] = "" , cohete7[N] = "" , cohete8[N] = "" , cohete9[N] = "",cohete8[N] = "" , cohete9[N] = "" , cohete10[N] = "" , cohete11[N] = "" , cohete12[N] = "", cohete13[N] = "", cohete14[N] = "", cohete15[N] = "" , cohete16[N] = "" , cohete16[N] = "", cohete17[N] = "" , cohete18[N] = "" , cohete19[N] = "";
  //Bucle for principal , se ejecutara las veces necesarias hasta que todos los cohetes lleguen al final

  for (int i = 0; (strlen(cohete) <= pos_final || strlen(cohete2) <= pos_final || strlen(cohete3) <= pos_final || strlen(cohete4) <= pos_final || strlen(cohete5) <= pos_final || strlen(cohete6) <= pos_final || strlen(cohete7) <= pos_final || strlen(cohete8) <= pos_final || strlen(cohete9) <= pos_final || strlen(cohete10) <= pos_final || strlen(cohete11) <= pos_final || strlen(cohete12) <= pos_final || strlen(cohete13) <= pos_final || strlen(cohete14) <= pos_final || strlen(cohete15) <= pos_final || strlen(cohete16) <= pos_final || strlen(cohete17) <= pos_final || strlen(cohete18) <= pos_final || strlen(cohete19) <= pos_final) ; i++) {
