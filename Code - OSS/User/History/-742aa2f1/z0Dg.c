...
//Cursores
void Mov(char tablero[N][M], zombis[N][M],int *pj_x, int *pj_y , int *pj2_x , int *pj2_y){
    
    char tecla = getch();

    tablero[*pj_x][*pj_y] = espacio;
    zombis[*pj2_x][pj2_y] = espacio;
...
Perdedor = loose(juego, juego , pos_x ,pos_y , pos_x2 , pos_y2);
